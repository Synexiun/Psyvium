...
| 14 | Messaging | 3 | 🟡 | Async voice/video `MediaMessage` shipped + verified; text threads still documented |
...
| 3 | Care delivery | In progress — Documentation ✅; Telehealth/Messaging/Comms landing now; Documents pending |
