...
> **Clinical excellence + staging-PHI wave (2026-07-13):** shared `common/clinical` + email (Resend), document blobs + ClamAV, field encryption (KMS + re-encrypt), audit anchors, **SIEM webhook/JSONL/S3**, production boot refusals, **pen-test readiness probes**, admin security posture, restore-drill checklist. See [`STAGING-PHI-RUNBOOK.md`](STAGING-PHI-RUNBOOK.md), [`PEN-TEST-READINESS.md`](PEN-TEST-READINESS.md), [`RESTORE-DRILL-CHECKLIST.md`](RESTORE-DRILL-CHECKLIST.md). Remaining for true PHI GA: BAAs, external pen-test execution, Object Lock on SIEM bucket, operator PITR attestation, clinical validation.
